...
const StakeAction = ({ farm, userDataLoaded, masterChefAddress, tab, earningTokenSymbol }) => {
  ...
  const handleStake = async (amount) => {
    ...
    dispatch(updateUserStakingBalance(account, farm.pid, tab))
    dispatch(updateUserStakedBalance(account, farm.pid, tab))
    dispatch(updateUserEarningsBalance(account, farm.pid, tab))
  ...
  const handleApprove = useCallback(async () => {
    try {
      ...
      dispatch(updateUserAllowance(account, farm.pid, tab))
  ...
  }, [account, dispatch, farm.pid, lpTokenName, onApprove, tab])
